...
num_loops = 10 # this is the "Dr. Gamage" requested version
#depth  = 10
...
for i in range(num_loops):
        ...
        #print("Does error occur = ",does_error_occur)
        error_qubit_index = random.randint(0,8)

        if does_error_occur >= error_probability_x:
                circuit.x(q[error_qubit_index]) #Bit flip error
